  ...
  init: function() {
    ...
    return window.onscroll = function() {
      ...
      if (prevScrollPos > currentScrollPos) {
        document.getElementById('myHeader').classList.add('nooculto');
        document.getElementById('myHeader').classList.remove('oculto');
      } else {
        document.getElementById('myHeader').classList.add('oculto');
        document.getElementById('myHeader').classList.remove('nooculto');
      }
  ...
  init: function() {
    return $("[data-open-loadmore]").click(function(e) {
      ...
      if ($(".loadmore").eq(index).length === 1) {
        $(".loadmore").eq(index).addClass("loadmore--show");
        return app.isotope4.init();
      } else {
...
app.youtube = {
  init: function() {
    ...
    $('.play:not(.played), .playhome:not(.played)').click(function() {
      var close, html, id, iframe, options, url;
